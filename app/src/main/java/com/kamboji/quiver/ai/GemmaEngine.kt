...
/**
 * Wraps MediaPipe LLM Inference to run a local Gemma model. Each [generate] call
 * uses a fresh session (single-turn, ephemeral — nothing about the conversation
 * is retained or written to disk).
 */
class GemmaEngine(
